 ...
 * ===================================================================================
 */
package com.app.xio.console.conso;
...
public class Messages {
	...
	/**
	 * @param param Name of the parameter to format message for.
	 * @param type 1 = WARNING | 2 = INFO | 0 = ERROR
	 * @param seed String message identifier to be used for creating a formatted message (ERROR|INFO|WARNING)
	 *
